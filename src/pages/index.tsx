  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Empower Your Team with HR Management System - Streamlining Student Data, Vacation Tracking, Marks Monitoring, and Performance Evaluations for Effective Student Management."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Empower Your Team with HR Management System - Streamlining Student Data, Vacation Tracking, Marks Monitoring, and Performance Evaluations for Effective Student Management.`}
            </Text>
            <Box
