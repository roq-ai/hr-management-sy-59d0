...
export function StudentListPage(props: StudentListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getStudents({
        relations: ['user', 'evaluation.count', 'marks.count', 'vacation.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('evaluation', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('marks', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'marks',
          header: 'Marks',
          accessorKey: 'marks',
          cell: ({ row: { original: record } }: any) => record?._count?.marks,
        }
      : null,
