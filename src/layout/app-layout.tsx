...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['system-administrator', 'team-lead', 'academic-advisor', 'data-analyst'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Marks', path: '/marks', entity: 'marks', service: AccessServiceEnum.PROJECT, icon: FiAward },
